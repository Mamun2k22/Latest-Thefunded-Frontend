  ...
  return (
    <>
      ...
      <section className="contact relative pt-20 xs:pt-24 pb-28 sm:pb-44">
        ...
        {/* cirlce */}
        <img
          className="cirlce hidden sm:block absolute -bottom-[25rem] -right-[6%] !max-w-[100rem]  w-[50rem] rotate-[80deg] opacity-[0.05]"
          src={circle}
          alt=""
        />
        {/* cirlce */}
        <img
          className="cirlce hidden sm:block absolute -top-[30%] -left-[6%] !max-w-[100rem]  w-[100rem] rotate-[55deg] opacity-[0.07]"
          src={circle}
          alt=""
        />
        {/* cirlce */}
        <img
          className="cirlce hidden sm:block absolute top-[25%] left-[37%] !max-w-[100rem]  w-[70rem] rotate-[70deg] opacity-[0.05]"
          src={circle}
          alt=""
        />
        {/* cirlce */}
